...
- **SOS Features:** Access immediate support during difficult moments
...
- Not contain personal information about others without consent
- Not include harmful, offensive, or inappropriate material
...
- Is not a substitute for professional healthcare services
...
While we strive for accuracy in health-related information:
- Information may not reflect the latest medical research
- Health milestones are estimates based on general research
- Individual health improvements may vary significantly
...
You retain ownership of content you provide to the Service. By using the Service, you grant us:
- A non-exclusive, worldwide, royalty-free license to use your content
- Rights to process your data as described in our Privacy Policy
- Permission to create anonymized, aggregated statistics for research
- The right to use your feedback to improve the Service

### 6.3 Feedback and Suggestions

Any feedback, suggestions, or ideas you provide to us:
- May be used by us without compensation to you
- Become our property and may be incorporated into the Service
- Do not create any confidential relationship between us
- May be shared with third parties at our discretion
...
- You should maintain appropriate security practices on your devices
...
- Pricing will be clearly disclosed before purchase
- Subscriptions will be processed through app store providers
- Cancellation policies will comply with app store requirements
- Refunds will be handled according to app store policies

### 8.3 Changes to Pricing

We reserve the right to:
- Introduce paid features with appropriate notice
- Modify pricing for new users at any time
- Grandfather existing users under current terms when reasonable
- Discontinue free services with reasonable advance notice
...
- Apple App Store Terms of Service (for iOS users)
- Google Play Terms of Service (for Android users)
- Respective app store policies and guidelines
...
- We do not guarantee any particular results from using the Service

### 10.3 Limitation of Liability

To the maximum extent permitted by law:
- Our total liability to you is limited to $100 or the amount you paid us in the past 12 months, whichever is greater
- We are not liable for indirect, incidental, or consequential damages
- We are not responsible for data loss not caused by our gross negligence
...
- Uninstalling the App (though this doesn't delete your account data)
...
- We reasonably believe termination is necessary to protect others
...
- When you next use the Service after changes are posted
...
Your continued use of the Service after changes constitutes acceptance of the new Terms. If you disagree with changes, you must stop using the Service and may delete your account.
...
If you are accessing the Service from outside the United Kingdom:
- You are responsible for compliance with local laws
- These Terms remain governed by English law
- You consent to jurisdiction in English courts
...
- Allow us a reasonable opportunity to address the issue
- Work with us in good faith to find a mutually acceptable resolution

### 15.2 Formal Disputes

For disputes that cannot be resolved informally:
- UK users may access appropriate consumer dispute resolution services
- EU users may use the European Commission's Online Dispute Resolution platform
- Other users may pursue resolution through appropriate legal channels
...
- The unenforceable provision will be replaced with an enforceable provision that achieves the same intent
- The validity of the remaining Terms will not be affected
...
These Terms are written in English. Any translations are provided for convenience only, and the English version will control in case of conflicts.
...
- You will use the Service responsibly and in accordance with these Terms

**Effective Date:** These Terms of Service are effective as of July 24, 2025.
