-- 🚨 NUCLEAR DATABASE RESET - NUKE EVERYTHING AND START FRESH 🚨
-- Run this in Supabase SQL Editor to completely reset your database

-- 1. NUKE EVERYTHING - Drop all tables, functions, triggers
...
-- 2. CREATE PROFILES TABLE (this is what your app code expects)
...
BEGIN
    ...
    RAISE NOTICE '✅ Tables created: profiles, financial_goals, craving_logs, goals';
